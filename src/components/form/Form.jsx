...
export default function Form() {
    ...
    const sendForm = (e) => {
        ...
        axios.post('http://192.168.0.24:3000/api/v1/requests', formInfo)
  ...
  return (
    <div className="w-full py-4 bg-[#28292B] text-white justify-center items-center flex flex-col lg:flex-row lg:py-28 lg:justify-evenly lg:items-center lg:h-full md:items-start" id="contact">
        ...
        <form onSubmit={sendForm} className="flex flex-col items-center justify-center w-4/5 gap-8 lg:gap-12 md:w-3/6 lg:w-2/6 md:pl-8">
